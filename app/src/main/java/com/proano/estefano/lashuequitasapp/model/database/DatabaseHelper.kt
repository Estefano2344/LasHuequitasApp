...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        private const val DATABASE_VERSION = 5 // Increment to ensure onUpgrade is called
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        val CREATE_RESTAURANTS_TABLE = """
            CREATE TABLE $TABLE_RESTAURANTS (
                ...
                $COLUMN_RESTAURANT_FOOD_TYPE TEXT NOT NULL DEFAULT '' -- Added new column
            )
        """.trimIndent()
    ...
    override fun onUpgrade(db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
        ...
        // During development, dropping and recreating tables is acceptable.
        // For production, you'd implement proper ALTER TABLE statements to preserve data.
